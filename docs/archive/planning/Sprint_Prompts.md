...
**Context File to provide:** `../../design/Overbet Brand System & Design Scheme.md` and `../../specs/pokernow_dev_spec_v0_3.md` (Sections 1-5).

**Prompt:**
> "I have initialized a Turborepo workspace for 'Overbet'. Your scope is strictly confined to the `apps/web` Next.js frontend directory; do not modify backend packages. Please finish the Phase 0->20 Foundation 'UI Shell Completion' based on `../../design/Overbet Brand System & Design Scheme.md` and `../../specs/pokernow_dev_spec_v0_3.md`. Your tasks are:
...
**Context File to provide:** `../../specs/pokernow_dev_spec_v0_3.md` (Sections 9 & 12).

**Prompt:**
> "I am building a poker platform called 'Overbet'. Please execute 'Sprint 3: Core Game loop & Persistence' according to `../../specs/pokernow_dev_spec_v0_3.md`. Your scope is strictly confined to the `packages/engine` and `packages/db` folders. Your tasks are:
...
**Context File to provide:** `../../specs/pokernow_dev_spec_v0_3.md` (Section 9).
...
**Context File to provide:** `../../specs/pokernow_dev_spec_v0_3.md` (Section 13).

**Prompt:**
> "Please execute the 'Accounting & Ledger v1 (Phase 50)' tasks for the 'Overbet' platform according to section 13 of `../../specs/pokernow_dev_spec_v0_3.md`. Your scope is strictly backend logic (e.g. creating an analytics/ledger service or adding math methods in `packages/engine`). Your tasks are:
