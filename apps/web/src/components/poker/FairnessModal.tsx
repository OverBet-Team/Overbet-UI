    ...
    <BaseModal isOpen onClose={onClose} isPortraitMobile={isPortraitMobile}>
      ...
      >
        ...
        <div className="flex items-center gap-2.5 mb-5">
          ...
          <Dialog.Title className="text-white text-lg font-bold font-display m-0">Provably Fair</Dialog.Title>
        </div>
            ...
            <div className="p-4 rounded-[14px] bg-[--success]/[0.05] border border-[--success]/20">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div>
                  ...
                  <code className="text-white/40 font-mono text-[9px] break-all">{lastHandReveal.commitment}</code>
                </div>
              </div>
            </div>
          ) : null}
