...
export default function WinnerOverlay({ winner, pot, handName, onDismiss }: WinnerOverlayProps) {
  ...
  return (
    <div
      style={{
        ...
        transition: fading ? "opacity 0.8s ease, transform 0.8s ease" : "opacity 0.35s ease, transform 0.35s ease",
        pointerEvents: fading ? "none" : "auto",
        background: "rgba(18, 15, 32, 0.96)",
        border: "1px solid rgba(124, 58, 237, 0.35)",
        borderRadius: 16,
        boxShadow: "0 8px 40px rgba(0,0,0,0.7), 0 0 0 1px rgba(255,255,255,0.04), 0 0 24px rgba(124,58,237,0.18)",
